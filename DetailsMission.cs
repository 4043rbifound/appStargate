...
namespace appStargate
{
    public partial class DetailsMission : Form
    {
        ...
        private void pctJournal_Click(object sender, EventArgs e)
        {
            ...
            journal frmJournal = new journal(planete, numero); // nouvelle instance = données fraîches
        ...
        private void cboInformateur_SelectedIndexChanged(object sender, EventArgs e)
        {
